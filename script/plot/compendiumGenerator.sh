...
pythonOut=$(python ${plotter} -d tile -s inverse -b 1 -e 8 -os tight -r wastar -r dps -r roundrobin1)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -b 6 -e 20 -os loose -r wastar -r dps -r roundrobin1)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t cpu -b 1 -e 8 -os tight -r wastar -r dps -r roundrobin1)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t cpu -b 6 -e 20 -os loose -r wastar -r dps -r roundrobin1)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t coverageplt -b 1 -e 20)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t par10 -b 1 -e 20)
...
echo "$pythonOut"
pythonOut=$(python ${plotter} -d pancake -s regular -z 50 -ht gap -b 1.7 -os loose)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d pancake -s regular -z 50 -ht gap -t cpu -b 1 -e 3 -os tight)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d pancake -s regular -z 50 -ht gap -t cpu -b 1.7 -os loose)
echo "$pythonOut"
...
#pythonOut=$(python ${plotter} -d pancake -s heavy -z 16 -ht gap -b 2 -os tight) 
#echo "$pythonOut"
#pythonOut=$(python ${plotter} -d pancake -s heavy -z 16 -ht gap -b 3 -os loose)
#echo "$pythonOut"
#pythonOut=$(python ${plotter} -d pancake -s heavy -z 16 -ht gap -t cpu -b 2 -os tight)
#echo "$pythonOut"

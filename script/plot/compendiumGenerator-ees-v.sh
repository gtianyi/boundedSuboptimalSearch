...
pythonOut=$(python ${plotter} -d tile -s inverse -b 1 -e 8 -os tight)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -b 6 -e 40 -os loose)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t cpu -b 1 -e 8 -os tight)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d tile -s inverse -t cpu -b 6 -e 40 -os loose)
echo "$pythonOut"
...
pythonOut=$(python ${plotter} -d vacuumworld -s uniform -b 1 -e 3 -os tight)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d vacuumworld -s uniform -b 3 -os loose)
echo "$pythonOut"
pythonOut=$(python ${plotter} -d vacuumworld -s uniform -t cpu -b 1 -e 3 -os tight)
echo "$pythonOut"
...
cp /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/bsscodebase/script/plot/BSS-tex-eesv/* /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/

mv /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/main.tex /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}.tex

cd /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}
latex /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}
bibtex /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}
latex /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}
latex /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}
dvips /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}.dvi
ps2pdf /home/aifs1/gu/phd/research/workingPaper/boundedSuboptimalSearch/plots/${TIMESTAMP}/bss-compendium-ees-variant-${TIMESTAMP}.ps
